...
export default function SloganBar({ phrases, index, fade }) {
  return (
    <div className={`text-white text-[10px] flex justify-end px-4 py-0.5 font-medium tracking-wide h-6 min-h-0 relative transition-all duration-300 bg-black bg-opacity-80 backdrop-blur-md  md:flex`}>
      <h1
