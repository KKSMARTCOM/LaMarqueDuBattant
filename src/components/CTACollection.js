...
export default function CTACollection() {
  ...
  return (
    <section className="relative max-w-5xl mb-16 mx-auto overflow-hidden w-full">
      <div 
        className="w-full min-h-[350px] flex items-center  justify-center relative"
        style={{
      ...
      >
        <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8 py-2 text-center">
